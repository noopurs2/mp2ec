...
# General information
YOUR_EMAIL = "noopurs2@illinois.edu" # <put your coursera account email>,
YOUR_SECRET = "" # <put your secret token from coursera>

# Section 1
IP_ADDRESS1 = "IP:PORT" # <put your first EC2 instance's IP address:port>
IP_ADDRESS2 = "IP:PORT" # <put your second instance's IP address:port>
